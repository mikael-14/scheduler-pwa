...
export const schedulesApi = {
  async fetchSchedules(panel = 'user') {
    try {
  ...
  async createSchedule(event: any, panel = 'user') {
  ...
  async updateSchedule(id: number | string, event: any, panel = 'user') {
  ...
  async deleteSchedule(id: number | string, panel = 'user') {
